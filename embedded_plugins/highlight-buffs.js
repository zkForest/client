...
const filter2xDefense = filter2xStat(StatIdx.Defense);  // defense rank upgrades are on planet.upgradeState[0]
const filter2xSpeed = filter2xStat(StatIdx.Speed);  // speed rank upgrades are on planet.upgradeState[2]
const filter2xRange = filter2xStat(StatIdx.Range);  // range rank upgrades are on planet.upgradeState[1]
